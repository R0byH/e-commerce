...
class ProductDiscount extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			array('id, product_id, discount_value, discount_unit, create_date, coupon_code, minimum_order_value, maximum_discount_amount, is_redeem_allowed', 'required'),
			array('id, product_id, discount_value, minimum_order_value, maximum_discount_amount', 'numerical', 'integerOnly'=>true),
			...
			array('id, product_id, discount_value, discount_unit, create_date, valid_from, valid_until, coupon_code, minimum_order_value, maximum_discount_amount, is_redeem_allowed', 'safe', 'on'=>'search'),
		);
	}
